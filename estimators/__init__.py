"""Public exports for ``lineareg.estimators``.

This subpackage exposes estimator classes and shared result containers while
avoiding eager imports. Lazy attribute loading keeps module import graphs
acyclic (notably preventing IV/GMM circular dependencies) and mirrors the
top-level ``lineareg`` package behaviour.
"""
