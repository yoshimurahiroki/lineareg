# lineareg/utils/helpers.py
"""Shared helper utilities for `lineareg` output modules.

These helpers consolidate common table-formatting logic so that
`lineareg.output.summary` and related modules do not need to reimplement
small utilities (parameter selection, LaTeX escaping, footer formatting).
"""
